...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar progressBar;
     ...
     String originalLink = "http://api.themoviedb.org/3/movie/popular?api_key=[ENTER API KEY]";
     String popularityLink = "https://api.themoviedb.org/3/discover/movie?api_key=[ENTER API KEY]&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1";
     String voteLink="https://api.themoviedb.org/3/movie/top_rated?api_key=[ENTER API KEY]&language=en-US&page=1";
    ...
    private void parseResult(String result) {
        try {
            ...
            for (int i = 0; i < posts.length(); i++) {
                ...
                item.setMovieId("https://api.themoviedb.org/3/movie/" +post.getString("id") + "?api_key=[ENTER API KEY]");
